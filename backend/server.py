...
if JWT_SECRET == 'default_secret_change_in_production':
    logger.warning("JWT_SECRET is using the default insecure value. Set JWT_SECRET env var before deploying to production.")

@app.on_event("shutdown")
async def shutdown_db_client():
    client.close()

# Serve static files in production (Railway/Docker)
